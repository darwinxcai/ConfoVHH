...
def main():
 ...
 for pdb in ('4MQS','5C1M','5JQH'):
  ...
  for seed in (1,2):
   ...
   if target is None:target=dict(id=id,groupId=inventory[pdb]['relatednessGroup'],receptorChain=rolemap['receptor'],vhhChain=rolemap['vhh'],receptorSequence=proteins[0],vhhSequence=proteins[1]);targets.append(target)
