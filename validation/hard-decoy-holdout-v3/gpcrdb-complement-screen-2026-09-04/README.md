...
Screened 4826 protein or unknown-type entities across 1426 captured entries, using 1375 distinct present sequences. 663 entities in 647 entries yield a complete numbered heavy-chain variable domain. These are review signals, not confirmed VHHs or direct receptor binders.
...
580 positive entities lack the historical descriptor/taxonomy signal. 3 are untagged and have no exact full-entity or numbered-domain match in the historical reference profiles. This does not establish novel VHH identity, receptor binding or independence.
