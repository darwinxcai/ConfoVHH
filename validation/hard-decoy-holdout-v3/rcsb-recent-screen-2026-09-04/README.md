...
Screened 705 protein or unknown-type entities across 112 captured entries, using 279 distinct present sequences. 11 entities in 8 entries yield a complete numbered heavy-chain variable domain. These are review signals, not confirmed VHHs or direct receptor binders.
...
6 positive entities lack the historical descriptor/taxonomy signal. 0 are untagged and have no exact full-entity or numbered-domain match in the historical reference profiles. This does not establish novel VHH identity, receptor binding or independence.
