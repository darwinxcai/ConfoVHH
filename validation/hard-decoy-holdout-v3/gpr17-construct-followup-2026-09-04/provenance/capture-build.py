...
INPUTS = {
    ...
    "validation/hard-decoy-holdout-v3/gpcrdb-complement-priority-review-2026-09-04/source-reviews.json": None,
}
...
def derive(root, out):
    ...
    report = {"schemaVersion": "1.0.0", "pdbId": "7Y89", "scope": "Species-annotation and deposited receptor sequence follow-up; no formal disposition change",
        "inputDigests": input_digests, "scriptSha256": sha(Path(__file__).read_bytes()), "sourceCaptures": sources,
