...
Screened 2424 protein or unknown-type entities across 692 captured entries, using 673 distinct present sequences. 374 entities in 345 entries yield a complete numbered heavy-chain variable domain. These are review signals, not confirmed VHHs or direct receptor binders.
...
348 positive entities lack the historical descriptor/taxonomy signal. 5 are untagged and have no exact full-entity or numbered-domain match in the historical reference profiles. This does not establish novel VHH identity, receptor binding or independence.
