...
Screened 19365 protein or unknown-type entities across 2911 captured entries, using 3787 distinct present sequences. 170 entities in 155 entries yield a complete numbered heavy-chain variable domain. These are review signals, not confirmed VHHs or direct receptor binders.
...
129 positive entities lack the historical descriptor/taxonomy signal. 1 are untagged and have no exact full-entity or numbered-domain match in the historical reference profiles. This does not establish novel VHH identity, receptor binding or independence.
