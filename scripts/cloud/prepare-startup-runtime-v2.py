...
EXECUTION_ID = 'confovhh-3p0g-startup-recovery-20260909-02'
...
def main():
    ...
    receipt = {'schema': 'confovhh.startup-runtime-preparation.v2', 'executionId': EXECUTION_ID,
    ...
    def event(event_name, **data):
        row = {'atUtc': now(), 'event': event_name, **data}; receipt['actions'].append(row)
    ...
    try:
        ...
        save(results / 'gate-blocked-execution.json', {
            'schema': 'confovhh.preparation-blocked-execution.v2', 'executionId': EXECUTION_ID,
