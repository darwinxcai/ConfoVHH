...
def remaining(value, current_epoch=None):
    ...
    require(0 < seconds <= MAX_SECONDS, 'Deadline must be within the remaining 4484.221-second cap')
    return seconds
...
def main():
    ...
    receipt = {'schema': 'confovhh.startup-gates.v2', 'executionId': args.execution_id,
