#!/usr/bin/env python3
"""Additive startup monitor with explicit wrapper arguments; frozen runner unchanged."""
...
def main():
    ...
    receipt = {'schema': 'confovhh.external-frozen-startup-monitor.v1', 'executionId': args.execution_id,
